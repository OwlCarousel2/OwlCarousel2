...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		watch: {
			...
			js :{
				files: ['src/**/*.js'],
				tasks: ['uglify:dist','concat:dist','copy:distToDocs']
			},
			helpers :{
	...
	// Tasks
	grunt.registerTask('dist', ['clean:dist', 'sass:dist', 'concat:dist', 'cssmin:dist', 'copy:themes', 'copy:distImages', 'uglify:dist','copy:readme']);
